...
class Segment {
  ...
  draw(iter) {
    ctx.strokeStyle = 'darkred'; // Add this line to set the color
...
class Creature {
  ...
  draw(iter) {
    var r = 4;
    ctx.fillStyle = 'salmon'; // Add this line to set the fill color
    ctx.strokeStyle = 'red'; // Add this line to set the stroke color
    ...
    ctx.fill();  // Fill the creature with the salmon color
    ctx.stroke(); // Outline the creature with the red color
